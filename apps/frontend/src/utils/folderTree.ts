 ...
 */
export function buildFolderTree(spells: Spell[], expandedState: FolderTreeState = {}, emptyFolders: string[] = []): FolderNode {
  ...
  const allPaths = Array.from(new Set([...spellFolderPaths, ...emptyFolders])).sort()
